...
Lume 是一个开放的小项目，作者也在持续用。如果你在用 Lume，希望能听到你的声音：

- 💡 **提建议 / 许愿功能** → [Discussions › Ideas](https://github.com/xiangjie-zhu/Lume/discussions/categories/ideas)
  想让 Lume 做什么？哪个操作用着不顺手？扔过来。给别人的点子点 👍，我会优先做呼声最高的。

- ❓ **使用问题** → [Discussions › Q&A](https://github.com/xiangjie-zhu/Lume/discussions/categories/q-a)
  "怎么做到…？"、"为什么…？" — 任何卡住的地方。

- 🐞 **报 bug** → [Issues](https://github.com/xiangjie-zhu/Lume/issues)
  尽量附上：系统版本、操作步骤、期望结果、实际结果。哪怕只写一句"这里卡住了"也比不说强。

- 📖 **分享你的用法** → [Discussions › Show and tell](https://github.com/xiangjie-zhu/Lume/discussions/categories/show-and-tell)
  读论文？签合同？整理扫描件？想听听大家怎么用。

- 💬 **随便聊聊** → [Discussions › General](https://github.com/xiangjie-zhu/Lume/discussions/categories/general)

如果 Lume 对你有帮助，点个 ⭐ 会是很大的鼓励。
